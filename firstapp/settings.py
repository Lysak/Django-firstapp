...
SECRET_KEY = 'ewx#nq!k4!!hofbkvm&19bq*b^@nq6pc6kr5wzk)r2s8x2_apr'
...
TEMPLATES = [
    {
        ...
        'DIRS': [os.path.join(BASE_DIR, 'templates'),
                 'D:/Django/djangoenv/Scripts/firstapp/article/templates',
                 'D:/Django/djangoenv/Scripts/firstapp/loginsys/templates'],
        'APP_DIRS': True,
        'OPTIONS': {
            'context_processors': [
...
STATICFILES_DIRS = [
    'static', 'D:/Django/djangoenv/Scripts/firstapp/',
]
